          ...
          <div className="revenue-breakdown">
            ...
            >
              <div className="revenue-info">
                <span className="revenue-name">{t.revenueCategories.subscriptions}</span>
            ...
            >
              <div className="revenue-info">
                <span className="revenue-name">{t.revenueCategories.travel}</span>
            ...
            >
              <div className="revenue-info">
                <span className="revenue-name">{t.revenueCategories.marketplace}</span>
            ...
            >
              <div className="revenue-info">
                <span className="revenue-name">{t.revenueCategories.others}</span>
        ...
        >
          ...
          <div className="roi-stats">
            <div className="roi-stat">
              <div className="roi-number">{t.roiStats.roi.value}</div>
              <div className="roi-label">{t.roiStats.roi.label}</div>
            </div>
            <div className="roi-stat">
              <div className="roi-number">{t.roiStats.breakeven.value}</div>
              <div className="roi-label">{t.roiStats.breakeven.label}</div>
            </div>
            <div className="roi-stat">
              <div className="roi-number">{t.roiStats.margin.value}</div>
              <div className="roi-label">{t.roiStats.margin.label}</div>
            </div>
          </div>
